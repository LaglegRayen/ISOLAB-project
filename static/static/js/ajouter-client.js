...
function previewClient() {
    ...
    // Populate preview modal with database field names
    document.getElementById('previewClientName').textContent = formData.clientName || '-';
    document.getElementById('previewClientSociety').textContent = formData.clientSociety || '-';
    document.getElementById('previewClientPhone').textContent = formData.clientPhone || '-';
    document.getElementById('previewClientEmail').textContent = formData.clientEmail || '-';
    document.getElementById('previewClientAddress').textContent = formData.clientAddress || '-';
    document.getElementById('previewClientLocation').textContent = formData.clientLocation || '-';
...
async function saveClient(clientData) {
    try {
        ...
        // Format data for API - match database structure exactly
        const apiData = {
            clientName: clientData.clientName,
            clientSociety: clientData.clientSociety,
